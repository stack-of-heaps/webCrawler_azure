const { FILE_TYPE } = require('./FileEnums.js/index.js.js');
...
module.exports.DATA = { label: FILE_TYPE.DATA, extensions: ['csv', 'dat', 'db', 'dbf', 'log', 'mdb', 'sav', 'sql', 'ini', 'config', 'sql', 'xml', 'torrent'] };

module.exports.SITE_RESOURCE = { label: FILE_TYPE.SITE_RESOURCE, extensions: ['asp', 'aspx', 'cer', 'cgi', 'css', 'js', 'php', 'rss', 'xhtml'] };

module.exports.PROGRAMMING = { label: FILE_TYPE.PROGRAMMING, extensions: ['c', 'cpp', 'java', 'h', 'swift', 'vb', 'py'] };
